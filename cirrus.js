...
var send = JSON.stringify(networkInterfaces).toString();

console.log( ip.address() );

console.log( JSON.stringify(networkInterfaces).toString() );
...
// config.json에 있는 명령으로 defaultConfig 생성
...
// function getLocalip(req,res{
// 	var networkInterfaces = os.networkInterfaces( );

// 	console.log( networkInterfaces );

// 	var senData1 = req.query.
// })
